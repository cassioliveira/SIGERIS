...
public class GeraRelatorios {
	 ...
	 * vindas da camada de apresentação. Depois exporta o relatório para o formato
	 * PDF antes de apresentar o mesmo no browser.
	 *
	 ...
	 * @throws IOException
	 */
	public void gerarPdf(String jasperFileName, String pdfFileName, List<?> dados, String titulo, String setor,
