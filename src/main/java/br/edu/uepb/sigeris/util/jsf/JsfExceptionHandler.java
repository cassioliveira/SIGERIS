package br.edu.uepb.sigeris.util.jsf;
...
import br.edu.uepb.sigeris.exceptions.NegocioException;
...
//    Recebe o tratador de exceções do JSF através da atribuição do construtor da classe
	...
	public void handle() {
		...
		/*
		 * Enquanto houverem eventos no iterador, pega o próximo evento. Pega o evento
		 * da origem da exceção no contexto do mesmo, através do getSource.
		 */
	...
	/**
	 * Captura o contexto da aplicação (nome) e a retorna quando o método é chamado.
	 *
	 * @param string
	 */
